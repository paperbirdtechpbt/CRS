#pragma checksum "E:\PBTProject\Ajit Singh\CrimeReportingSystem\CRS\CRS.Web\Views\Crime\AddCrime.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6351720baa667caf0591ee0a0d21e6ec5c1c30c3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6351720baa667caf0591ee0a0d21e6ec5c1c30c3", @"/Views/Crime/AddCrime.cshtml")]
	...
	function dynamic(jsonObj) {
		try {
			...
			for (i = 0; i < jsonObj.length; i++) {
				...
				//Type of RadioButton
				if (jsonObj");
                WriteLiteral(@"[i].mstCrimeHeadTypeID == 2) {
				...
				//Type of Calander
				if (jsonObj[i].mstCrimeHead");
                WriteLiteral(@"TypeID == 5) {
				...
				//mst");
                WriteLiteral(@"CrimeHeadTypeID of disable Textbox
	...
	function submitfunc() {
		...
		$.ajax({
			...
			data: {
				...
				""ComplainerContactNo"": document.getElementById(""txtcomplainerc");
                WriteLiteral(@"ontactno"").value,
